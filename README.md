A ranking system for students where it takes their scores , adds them to make a mean mark which is then run into the grading function where it is assigned a grade.
